...
const bitArrayFixture = contract(
  ...
  boundary(
    { op: 0n, a: 0n, b: 1n }, { op: 0n, a: 2n, b: 1n },
    { op: 1n, a: 63n, b: 1n }, { op: 1n, a: 64n, b: 1n },
    { op: 2n, a: 63n, b: 1n }, { op: 2n, a: 64n, b: 1n }, { op: 2n, a: 127n, b: 1n },
    { op: 3n, a: 4095n, b: 1n }, { op: 3n, a: 4096n, b: 1n },
    { op: 4n, a: 1n }, { op: 6n, a: 1n }, { op: 4n, a: 0n }, { op: 6n, a: 1n },
    { op: 5n, a: 0x8000000000000001n }, { op: 7n, a: 1n },
  ),
);
...
const hashMapFixture = contract(
  ...
  boundary(
    { op: 12n }, { op: 1n, a: 999n },
    { op: 0n, a: 15n, b: 10n }, { op: 0n, a: 31n, b: 20n }, { op: 0n, a: 47n, b: 30n },
    { op: 0n, a: 31n, b: 22n }, { op: 1n, a: 31n }, { op: 2n, a: 47n },
    ...Array.from({ length: 13 }, (_, index) => ({ op: 0n, a: BigInt(index + 100), b: BigInt(index) })),
    { op: 0n, a: 999n, b: 1n }, { op: 7n, a: 99n }, { op: 5n, a: 99n },
    { op: 4n, a: 15n }, { op: 0n, a: 63n, b: 40n }, { op: 8n, a: 1n },
    { op: 9n, a: 1n }, { op: 6n, a: 0xffffffffffffffffn }, { op: 10n }, { op: 11n },
  ),
);
...
const hashSetFixture = contract(
  ...
  boundary(
    { op: 10n }, { op: 1n, a: 999n }, { op: 11n, a: 15n },
    { op: 0n, a: 31n }, { op: 0n, a: 47n },
    ...Array.from({ length: 13 }, (_, index) => ({ op: 0n, a: BigInt(index + 100) })),
    { op: 0n, a: 999n }, { op: 5n, a: 99n }, { op: 3n, a: 99n },
    { op: 2n, a: 15n }, { op: 0n, a: 63n }, { op: 6n, a: 1n },
    { op: 7n, a: 1n }, { op: 4n, a: 0xffffffffffffffffn }, { op: 8n }, { op: 9n },
  ),
);
...
const collectionFixture = contract(
  ...
  boundary(
    { op: 11n },
    { op: 0n, a: 1n, b: 0x9358942en, c: 5n }, { op: 0n, a: 1n, b: 20n, c: 5n },
    { op: 0n, a: 1n, b: 30n, c: 0xffffffffffffffffn }, { op: 0n, a: 17n, b: 40n, c: 7n },
    { op: 0n, a: 33n, b: 50n, c: 9n }, { op: 3n, a: 1n, b: 5n, c: 5n },
    { op: 6n, a: 1n }, { op: 7n, a: 1n }, { op: 5n, a: 0n },
    { op: 2n, a: 0n, b: 99n }, { op: 2n, a: 99n, b: 77n },
    { op: 1n, a: 2n }, { op: 1n, a: 99n }, { op: 8n, a: 1n },
    { op: 9n, a: 1n }, { op: 10n },
    ...Array.from({ length: 14 }, (_, index) => ({ op: 0n, a: 1n, b: BigInt(100 + index), c: BigInt(index) })),
    { op: 0n, a: 1n, b: 999n, c: 99n }, { op: 11n },
    { op: 0n, a: 5n, b: 40n, c: 4n }, { op: 0n, a: 5n, b: 20n, c: 2n }, { op: 1n, a: 1n },
    { op: 11n },
    { op: 0n, a: 5n, b: 40n, c: 4n }, { op: 0n, a: 5n, b: 20n, c: 2n }, { op: 0n, a: 5n, b: 10n, c: 1n }, { op: 1n, a: 1n },
    { op: 11n },
    { op: 0n, a: 5n, b: 40n, c: 4n }, { op: 0n, a: 5n, b: 20n, c: 2n }, { op: 0n, a: 5n, b: 60n, c: 6n },
    { op: 0n, a: 5n, b: 10n, c: 1n }, { op: 0n, a: 5n, b: 30n, c: 3n }, { op: 0n, a: 5n, b: 50n, c: 5n },
    { op: 0n, a: 5n, b: 70n, c: 7n }, { op: 1n, a: 0n },
    { op: 11n }, { op: 12n, a: 48n },
  ),
);
...
const linkedListFixture = contract(
  ...
  boundary(
    { op: 9n }, { op: 8n, a: 0n }, { op: 1n, a: 10n }, { op: 0n, a: 20n },
    { op: 2n, a: 0n, b: 30n }, { op: 3n, a: 0n, b: 40n },
    { op: 2n, a: 99n, b: 50n }, { op: 3n, a: 99n, b: 60n },
    { op: 6n }, { op: 7n }, { op: 5n, a: 0n, b: 99n }, { op: 5n, a: 99n, b: 77n },
    { op: 4n, a: 0n }, { op: 1n, a: 55n },
    ...Array.from({ length: 5 }, (_, index) => ({ op: 1n, a: BigInt(100 + index) })),
    { op: 1n, a: 999n }, { op: 4n, a: 1n }, { op: 0n, a: 77n }, { op: 9n },
  ),
);
