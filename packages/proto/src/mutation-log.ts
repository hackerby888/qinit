...
export const AssetOwnershipChange = defineStruct(
  "AssetOwnershipChange",
  ASSET_CHANGE_FIELDS,
);

export const AssetPossessionChange = defineStruct(
...
export function encodeAssetOwnershipChangeLog(
  ...
  message.numberOfDecimalPlaces = numberOfDecimalPlaces;
  message.unitOfMeasurement = unitOfMeasurement;
  return message.bytes.subarray(
    0,
    AssetOwnershipChange.OFFSETS._terminator,
  );
}

// Core uses the same payload layout for ownership and possession changes.
export const encodeAssetPossessionChangeLog =
...
export function encodeAssetOwnershipManagingContractChangeLog(
  ...
  return message.bytes.subarray(
    0,
    AssetOwnershipManagingContractChange.OFFSETS._terminator,
  );
}
...
export function encodeAssetPossessionManagingContractChangeLog(
  ...
  return message.bytes.subarray(
    0,
    AssetPossessionManagingContractChange.OFFSETS._terminator,
  );
}
