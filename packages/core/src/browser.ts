...
// Duplicates ./crypto/sign-sync because that module loads the same FourQ via CJS `require` (needed for
// `bun build --compile`), which a page bundle cannot run. Collapsing the two breaks one target.
