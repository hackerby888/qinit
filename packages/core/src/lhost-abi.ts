...
const signature = (params: readonly LhostValueType[], results: readonly LhostValueType[]): LhostFunctionSignature => Object.freeze({
...
export const LHOST_ABI = Object.freeze(Object.fromEntries(
...
export const SYSTEM_PROCEDURES = Object.freeze(Object.fromEntries(
