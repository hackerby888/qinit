...
import { runSelfUpdate, type SelfUpdateResult } from "../../ops/update";

type UpdateState = { phase: "running" } | SelfUpdateResult | { phase: "error"; message: string };
...
export function Update({ commandArgs }: { commandArgs: CommandArguments }) {
    ...
    return (
        <Box flexDirection="column">
            ...
            {state.phase === "error" && <Text color={theme.err}>ERROR: {state.message}</Text>}
        </Box>
    );
}
