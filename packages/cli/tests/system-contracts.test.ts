...
test("systemContracts: parses contract_def.h index->name->file + IDL", () => {
  ...
  writeFileSync(join(root, "src", "contract_core", "contract_def.h"), `
...
test("resolveContract: user before system; by name or index", () => {
  const sets: ContractSets = {
    user: [{ index: 28, name: "MyTok", armed: true, constructed: true, version: 1, codeHash: "", functions: [], procedures: [], source: "u" } as any],
    system: [{ index: 1, name: "QX", file: "Qx.h", source: "s", idl: { name: "QX", functions: {}, procedures: {} } } as any],
  };
