...
#define INITIALIZE() typedef NoData INITIALIZE_locals; static void __impl_initialize(const QpiContextProcedureCall& qpi, void* state, NoData& input, NoData& output, void* locals)
#define BEGIN_EPOCH() typedef NoData BEGIN_EPOCH_locals; static void __impl_beginEpoch(const QpiContextProcedureCall& qpi, void* state, NoData& input, NoData& output, void* locals)
#define END_EPOCH() typedef NoData END_EPOCH_locals; static void __impl_endEpoch(const QpiContextProcedureCall& qpi, void* state, NoData& input, NoData& output, void* locals)
#define BEGIN_TICK() typedef NoData BEGIN_TICK_locals; static void __impl_beginTick(const QpiContextProcedureCall& qpi, void* state, NoData& input, NoData& output, void* locals)
#define END_TICK() typedef NoData END_TICK_locals; static void __impl_endTick(const QpiContextProcedureCall& qpi, void* state, NoData& input, NoData& output, void* locals)
...
#define PRE_ACQUIRE_SHARES() typedef NoData PRE_ACQUIRE_SHARES_locals; static void __impl_preAcquireShares(const QpiContextProcedureCall& qpi, void* state, void* input, void* output, void* locals)
#define POST_ACQUIRE_SHARES() typedef NoData POST_ACQUIRE_SHARES_locals; static void __impl_postAcquireShares(const QpiContextProcedureCall& qpi, void* state, void* input, void* output, void* locals)
#define PRE_RELEASE_SHARES() typedef NoData PRE_RELEASE_SHARES_locals; static void __impl_preReleaseShares(const QpiContextProcedureCall& qpi, void* state, void* input, void* output, void* locals)
#define POST_RELEASE_SHARES() typedef NoData POST_RELEASE_SHARES_locals; static void __impl_postReleaseShares(const QpiContextProcedureCall& qpi, void* state, void* input, void* output, void* locals)
#define POST_INCOMING_TRANSFER() typedef NoData POST_INCOMING_TRANSFER_locals; static void __impl_postIncomingTransfer(const QpiContextProcedureCall& qpi, void* state, void* input, void* output, void* locals)
...
#define SET_SHAREHOLDER_PROPOSAL() typedef NoData SET_SHAREHOLDER_PROPOSAL_locals; static void __impl_setShareholderProposal(const QpiContextProcedureCall& qpi, void* state, void* input, void* output, void* locals)
#define SET_SHAREHOLDER_VOTES() typedef NoData SET_SHAREHOLDER_VOTES_locals; static void __impl_setShareholderVotes(const QpiContextProcedureCall& qpi, void* state, void* input, void* output, void* locals)
...
#define CALL_OTHER_CONTRACT_FUNCTION(c, f, in, out) InterContractCallError interContractCallError = __qpi_call_other(c, f, in, out)
#define INVOKE_OTHER_CONTRACT_PROCEDURE(c, p, in, out, reward) InterContractCallError interContractCallError = __qpi_invoke_other(c, p, in, out, reward)
