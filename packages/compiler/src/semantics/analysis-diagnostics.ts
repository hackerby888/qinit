...
// A construct that lowers correctly but is non-canonical. Deduplicated: a type used fifty times should not produce fifty warnings.
...
// The first diagnostic since a baseline that means a body was not lowered faithfully; advisories are skipped, since style must not fail an authoritative body.
