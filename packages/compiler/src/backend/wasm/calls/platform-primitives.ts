import { PlatformCapability, PlatformPrimitiveKind, PlatformWasmOp, PrimitiveOperand, PrimitiveResultChannel } from "../../../shared/enums";

export { PlatformCapability, PlatformPrimitiveKind, PlatformWasmOp, PrimitiveOperand, PrimitiveResultChannel };
