...
import type { AssignmentExpression } from "../expressions/assignment-types";

export function tryEmitTestHarnessAssignment(context: FunctionEmissionContext, expression: AssignmentExpression): boolean {
    if (
    ...
    const hostCall = watIr.functionCall(hostFunction, watIr.operation("i32.wrap_i64", assignedValue));
