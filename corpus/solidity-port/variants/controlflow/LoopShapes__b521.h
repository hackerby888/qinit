...
// Variant: entryOrder=reversed entryShape=direct initStyle=full loopShape=zero placement=first stateOrder=declared temporaries=locals width=uint64
...
struct LoopShapes : public ContractBase
{
    ...
    PUBLIC_PROCEDURE_WITH_LOCALS(Sum)
    {
        ...
        state.mut().total += (uint64)locals.i;
        locals.count++;
        }
