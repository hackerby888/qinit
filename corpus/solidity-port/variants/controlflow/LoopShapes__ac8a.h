...
// Variant: entryOrder=declared entryShape=direct initStyle=full loopShape=clamped placement=first stateOrder=reversed temporaries=locals width=sint32
...
struct LoopShapes : public ContractBase
{
    ...
    PUBLIC_PROCEDURE_WITH_LOCALS(Sum)
    {
        ...
        state.mut().total += (sint32)locals.i;
        locals.count++;
        }
