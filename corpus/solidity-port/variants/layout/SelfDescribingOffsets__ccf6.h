...
// Variant: entryOrder=reversed entryShape=direct initStyle=empty layout=widestFirst placement=first stateOrder=declared temporaries=stateScratch width=sint32
