...
// Variant: entryOrder=reversed entryShape=direct initStyle=absent layout=widestLast placement=first stateOrder=reversed temporaries=locals width=sint8
...
struct SelfDescribingOffsets : public ContractBase
{
    ...
    PUBLIC_PROCEDURE_WITH_LOCALS(Measure)
    {
        ...
        state.mut().probe.middle = (sint8)input.value;
