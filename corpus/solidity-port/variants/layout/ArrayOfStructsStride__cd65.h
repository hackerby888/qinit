...
// Variant: capacity=1024 entryOrder=declared entryShape=direct initStyle=absent layout=widestFirst placement=first stateOrder=declared temporaries=locals
