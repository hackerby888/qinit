...
// Variant: entryOrder=reversed entryShape=direct initStyle=full layout=widestFirst placement=last stateOrder=declared temporaries=stateScratch width=sint16
