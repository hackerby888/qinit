...
import { loadWasmFixture, wasmFixtureManifest, wasmFixtureNames } from "./wasm-fixtures";
...
describe("in-memory Wasm fixtures", () => {
    ...
    test("every manifest entry compiles to a valid module with its declared slot", async () => {
